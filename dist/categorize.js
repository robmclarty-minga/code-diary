...
const CATEGORY_REGEX = /^(feat|fix|refactor|docs|chore|test|style|perf|build|ci)(\(.+\))?:/i;
export const categorizeCommit = (commit) => {
...
export const extractTilItems = (subject, body) => {
    const items = [];
...
export const assignDaySegment = (timestamp, tzOffset) => {
...
export const buildRepoEntry = (repoPath, commits) => {
...
export const buildDiaryEntry = (date, repos) => {
    const seen = new Set();
    const tilItems = [];
